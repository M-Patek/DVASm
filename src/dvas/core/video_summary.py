"""Video summarization and semantic segmentation for DVAS.

Provides video summarization, keyframe extraction, adaptive sampling,
and semantic-aware video segmentation.
"""
...
from .data_structures import MinMaxHeap, SlidingWindowBuffer
from .frame_metrics import CompositeImportance, HistogramEntropyImportance, MotionImportance
